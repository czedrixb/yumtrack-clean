  ...
  const handleInstallApp = async () => {
    ...
    if (isInWebView) {
      ...
      toast({
        ...
        description: "YumTrack will open in your browser where you can install it.",
      });
      return;
    }
    ...
    // If PWA install isn't available, show helpful message
    toast({
      title: "Install not available",
      description: "YumTrack installation isn't available on this device/browser.",
    });
  };
